...
cljs.core.extend_object_BANG_ = function extend_object_BANG_(obj, fn_map) {
  ...
  while(true) {
    if(i__5336_5342 < count__5335_5341) {
      ...
      var temp__4126__auto___5351 = cljs.core.seq.call(null, seq__5333_5339);
      if(temp__4126__auto___5351) {
        var seq__5333_5352__$1 = temp__4126__auto___5351;
...
cljs.core.ObjMap.prototype.call = function() {
  var G__5585 = null;
  var G__5585__2 = function(self__, k) {
    var self__ = this;
    var self____$1 = this;
    var coll = self____$1;
    return coll.cljs$core$ILookup$_lookup$arity$2(null, k)
  };
  var G__5585__3 = function(self__, k, not_found) {
    var self__ = this;
    var self____$1 = this;
    var coll = self____$1;
    return coll.cljs$core$ILookup$_lookup$arity$3(null, k, not_found)
...
cljs.core.PersistentArrayMap.prototype.call = function() {
  var G__5601 = null;
  var G__5601__2 = function(self__, k) {
    var self__ = this;
    var self____$1 = this;
    var coll = self____$1;
    return coll.cljs$core$ILookup$_lookup$arity$2(null, k)
  };
  var G__5601__3 = function(self__, k, not_found) {
    var self__ = this;
    var self____$1 = this;
    var coll = self____$1;
    return coll.cljs$core$ILookup$_lookup$arity$3(null, k, not_found)
...
cljs.core.PersistentTreeMap.prototype.call = function() {
  var G__5658 = null;
  var G__5658__2 = function(self__, k) {
    var self__ = this;
    var self____$1 = this;
    var coll = self____$1;
    return coll.cljs$core$ILookup$_lookup$arity$2(null, k)
  };
  var G__5658__3 = function(self__, k, not_found) {
    var self__ = this;
    var self____$1 = this;
    var coll = self____$1;
    return coll.cljs$core$ILookup$_lookup$arity$3(null, k, not_found)
...
cljs.core.replace = function replace(smap, coll) {
  if(cljs.core.vector_QMARK_.call(null, coll)) {
    ...
    return cljs.core.map.call(null, function(p1__5707_SHARP_) {
      var temp__4124__auto__ = cljs.core.find.call(null, smap, p1__5707_SHARP_);
      if(cljs.core.truth_(temp__4124__auto__)) {
        var e = temp__4124__auto__;
...
cljs.core.subseq = function() {
  ...
  var subseq__3 = function(sc, test, key) {
    ...
    if(cljs.core.truth_(cljs.core.PersistentHashSet.fromArray([cljs.core._GT_, null, cljs.core._GT__EQ_, null], true).call(null, test))) {
      ...
      if(cljs.core.truth_(temp__4126__auto__)) {
        var vec__5737 = temp__4126__auto__;
  ...
  var subseq__5 = function(sc, start_test, start_key, end_test, end_key) {
    ...
    if(cljs.core.truth_(temp__4126__auto__)) {
      var vec__5738 = temp__4126__auto__;
...
cljs.core.rsubseq = function() {
  ...
  var rsubseq__3 = function(sc, test, key) {
    ...
    if(cljs.core.truth_(cljs.core.PersistentHashSet.fromArray([cljs.core._LT_, null, cljs.core._LT__EQ_, null], true).call(null, test))) {
      ...
      if(cljs.core.truth_(temp__4126__auto__)) {
        var vec__5741 = temp__4126__auto__;
  ...
  var rsubseq__5 = function(sc, start_test, start_key, end_test, end_key) {
    ...
    if(cljs.core.truth_(temp__4126__auto__)) {
      var vec__5742 = temp__4126__auto__;
...
cljs.core.pr_sequential_writer = function pr_sequential_writer(writer, print_one, begin, sep, end, opts, coll) {
  ...
  while(true) {
    if(i__5780_5784 < count__5779_5783) {
      ...
      var temp__4126__auto___5790 = cljs.core.seq.call(null, seq__5777_5781);
      if(temp__4126__auto___5790) {
        var seq__5777_5791__$1 = temp__4126__auto___5790;
...
cljs.core.pr_seq_writer = function pr_seq_writer(objs, writer, opts) {
  ...
  while(true) {
    if(i__5839 < count__5838) {
      ...
      var temp__4126__auto__ = cljs.core.seq.call(null, seq__5836);
      if(temp__4126__auto__) {
        var seq__5836__$1 = temp__4126__auto__;
...
cljs.core.Atom.prototype.cljs$core$IWatchable$_notify_watches$arity$3 = function(this$, oldval, newval) {
  ...
  while(true) {
    if(i__5863 < count__5862) {
      ...
      var temp__4126__auto__ = cljs.core.seq.call(null, seq__5860);
      if(temp__4126__auto__) {
        var seq__5860__$1 = temp__4126__auto__;
...
cljs.core.reset_BANG_ = function reset_BANG_(a, new_value) {
  var temp__4126__auto___5883 = a.validator;
  if(cljs.core.truth_(temp__4126__auto___5883)) {
    var validate_5884 = temp__4126__auto___5883;
          ...
          if(cljs.core.map_QMARK_.call(null, x)) {
            ...
            while(true) {
              if(i__5904_5910 < count__5903_5909) {
                ...
                var temp__4126__auto___5918 = cljs.core.seq.call(null, seq__5901_5907);
                if(temp__4126__auto___5918) {
                  var seq__5901_5919__$1 = temp__4126__auto___5918;
                          ...
                          return function iter__5948(s__5949) {
                            return new cljs.core.LazySeq(null, function(map__5943, map__5943__$1, keywordize_keys, keyfn) {
                              return function() {
                                ...
                                while(true) {
                                  var temp__4126__auto__ = cljs.core.seq.call(null, s__5949__$1);
                                  if(temp__4126__auto__) {
                                    var s__5949__$2 = temp__4126__auto__;
...
cljs.core.special_symbol_QMARK_ = function special_symbol_QMARK_(x) {
  return cljs.core.contains_QMARK_.call(null, cljs.core.PersistentHashSet.fromArray([new cljs.core.Symbol(null, "\x26", "\x26", -1640531489, null), null, new cljs.core.Symbol(null, "defrecord*", "defrecord*", 774272013, null), null, new cljs.core.Symbol(null, "try", "try", -1640416396, null), null, new cljs.core.Symbol(null, "loop*", "loop*", -1537374273, null), null, new cljs.core.Symbol(null, "do", "do", -1640528316, null), null, new cljs.core.Symbol(null, "letfn*", "letfn*", 1548249632, null), 
  null, new cljs.core.Symbol(null, "if", "if", -1640528170, null), null, new cljs.core.Symbol(null, "new", "new", -1640422567, null), null, new cljs.core.Symbol(null, "ns", "ns", -1640528002, null), null, new cljs.core.Symbol(null, "deftype*", "deftype*", -978581244, null), null, new cljs.core.Symbol(null, "let*", "let*", -1637213400, null), null, new cljs.core.Symbol(null, "js*", "js*", -1640426054, null), null, new cljs.core.Symbol(null, "fn*", "fn*", -1640430053, null), null, new cljs.core.Symbol(null, 
  "recur", "recur", -1532142362, null), null, new cljs.core.Symbol(null, "set!", "set!", -1637004872, null), null, new cljs.core.Symbol(null, ".", ".", -1640531481, null), null, new cljs.core.Symbol(null, "quote", "quote", -1532577739, null), null, new cljs.core.Symbol(null, "throw", "throw", -1530191713, null), null, new cljs.core.Symbol(null, "def", "def", -1640432194, null), null], true), x)
};
